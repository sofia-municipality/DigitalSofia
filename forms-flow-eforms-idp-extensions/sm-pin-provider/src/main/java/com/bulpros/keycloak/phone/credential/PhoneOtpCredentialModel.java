package com.bulpros.keycloak.phone.credential;
...
public class PhoneOtpCredentialModel extends CredentialModel {
    ...
    private static Optional<CredentialModel> getOtpCredentialModel(@NotNull UserModel user) {
        return user.credentialManager().getStoredCredentialsByTypeStream(PhoneOtpCredentialModel.TYPE).findFirst();
    }

    public static Optional<PhoneOtpCredentialModel.SmsOtpCredentialData> getSmsOtpCredentialData(
            @NotNull UserModel user) {
        return getOtpCredentialModel(user).map(credentialModel -> {
            try {
    ...
    public static void updateOtpCredential(@NotNull UserModel user,
            @NotNull PhoneOtpCredentialModel.SmsOtpCredentialData credentialData, String secretValue) {
        getOtpCredentialModel(user).ifPresent(credential -> {
            try {
