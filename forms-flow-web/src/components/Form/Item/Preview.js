...
const Preview = ({ handleNext, hideComponents, activeStep }) => {
  ...
  useEffect(() => {
    if (formProcessList?.parentFormId) {
      getFormHistory(formProcessList?.parentFormId)
        .then((res) => {
  ...
  return (
    <div className="container">
      ...
      <LoadingOverlay active={newpublishClicked} spinner text={t("Loading...")}>
        <Form
          form={form}
