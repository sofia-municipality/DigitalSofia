...
const TranslationAdministration = () => {
  ...
  const { data: selectLanguages } = useFetchLanguages(tenantKey);
  const {
    data = {},
    isLoading,
...
const TranslationAdministrationWrapper = (props) => {
  const formioToken = useSelector(state => state.user.formioToken);
  return formioToken ? <TranslationAdministration {...props} /> : <Loading />;
};

export default TranslationAdministrationWrapper;
