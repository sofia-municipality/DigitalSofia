...
import { TASK_FILTER_LIST_DEFAULT_PARAM, getTaskSearchFilterDefaultParam } from "../constants/taskConstants";
import {
  getFirstResultIndex,
  getSearchParams,
  ...
  switch (action.type) {
    case ACTION_CONSTANTS.SET_USER_DETAILS:
        return { 
          ...state, 
          filterListSearchParams: { 
            ...state.filterListSearchParams, 
            ...getTaskSearchFilterDefaultParam(action.payload.preferred_username) 
          },
        };
    ...
    case ACTION_CONSTANTS.UPDATE_FILTER_LIST_SEARCH_PARAMS:
      return {
        ...state,
        filterListSearchParams: getSearchParams(
          action.payload,
