...
const OverrideExternalsPlugin = require("./cracoPlugins/overrideExternalsPlugin");
const OverrideCSSModulesPlugin = require("./cracoPlugins/overrideCSSModulesPlugin");

const shouldMinimize = process.env.NODE_ENV == "production";

const overrideExternalsPlugin = {
  plugin: OverrideExternalsPlugin,
  options: {}
};

const overrideCSSModulesPlugin = {
  plugin: OverrideCSSModulesPlugin,
  options: {}
};
...
module.exports = {
  plugins: [singleSpaAppPlugin, overrideExternalsPlugin, overrideCSSModulesPlugin],
  devServer: {
    port: 3004,
    headers: {
