...
@Component
@Slf4j
public class UserConfirmedDataRoute extends RouteBuilder {
    ...
    public void configure() {
        ...
        rest("/evrotrust/document/doc/identification")
                .post()
                .consumes(MediaType.APPLICATION_JSON_VALUE)
                .type(ConfirmPersonalDataRequest.class)
                .outType(EvrotrustConfirmPersonalDataResponse.class)
                .route().routeGroup("EVROTRUST").routeId("EvrotrustUserConfirmDataRequest")
                .to("bean:EvrotrustService?method=confirmPersonalData(${body})");
    }
}
