 ...
 *         &lt;element name="LiquidationOrInsolvency" type="{http://egov.bg/RegiX/AV/TR/ActualStateResponse}LiquidationOrInsolvency" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ActualStateResponseType", namespace = "http://egov.bg/RegiX/AV/TR/ActualStateResponse", propOrder = {
    ...
    "details",
    "dataValidForDate",
    "liquidationOrInsolvency"
})
@XmlRootElement(name = "ActualStateResponse", namespace = "http://egov.bg/RegiX/AV/TR/ActualStateResponse")
public class ActualStateResponseType {
    ...
    protected String dataValidForDate;
    @XmlElement(name = "LiquidationOrInsolvency")
    @XmlSchemaType(name = "string")
    protected LiquidationOrInsolvency liquidationOrInsolvency;
     ...
     *     
     */
    public void setDataValidForDate(String value) {
        this.dataValidForDate = value;
    }

    /**
     * Gets the value of the liquidationOrInsolvency property.
     * 
     * @return
     *     possible object is
     *     {@link LiquidationOrInsolvency }
     *     
     */
    public LiquidationOrInsolvency getLiquidationOrInsolvency() {
        return liquidationOrInsolvency;
    }

    /**
     * Sets the value of the liquidationOrInsolvency property.
     * 
     * @param value
     *     allowed object is
     *     {@link LiquidationOrInsolvency }
     *     
     */
    public void setLiquidationOrInsolvency(LiquidationOrInsolvency value) {
