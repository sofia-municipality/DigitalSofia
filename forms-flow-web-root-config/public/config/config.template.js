...
/*  //TODO Remove the MF variables from config.js Not being used anywhere as these are build time variable
  ...
  REACT_APP_TASK_PAGE_NEW_DESIGN_ENABLED: "${REACT_APP_TASK_PAGE_NEW_DESIGN_ENABLED}",
  REACT_APP_TASK_PAGE_TASK_HEADER_ACTIONS_ENABLED: "${REACT_APP_TASK_PAGE_TASK_HEADER_ACTIONS_ENABLED}",
  REACT_APP_TASK_DETAILS_HISTORY_TAB_ENABLED: "${REACT_APP_TASK_DETAILS_HISTORY_TAB_ENABLED}",
  REACT_APP_TASK_DETAILS_DIAGRAM_TAB_ENABLED: "${REACT_APP_TASK_DETAILS_DIAGRAM_TAB_ENABLED}",
  REACT_APP_MULTI_LANGUAGE_ENABLED: "${REACT_APP_MULTI_LANGUAGE_ENABLED}",
  ...
  REACT_APP_TASK_LIST_DEFAULT_ASSIGNEE: "${REACT_APP_TASK_LIST_DEFAULT_ASSIGNEE}",
};
