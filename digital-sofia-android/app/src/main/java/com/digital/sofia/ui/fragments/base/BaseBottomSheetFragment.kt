...
import com.digital.sofia.databinding.BottomSheetBaseLayoutBinding
...
import com.digital.sofia.utils.SoftKeyboardStateWatcher
...
//        )
    ...
    private fun subscribeToLiveData() {
        ...
        viewModel.showMessageLiveData.observe(viewLifecycleOwner) { message ->
            showMessage(message)
        }
    }
