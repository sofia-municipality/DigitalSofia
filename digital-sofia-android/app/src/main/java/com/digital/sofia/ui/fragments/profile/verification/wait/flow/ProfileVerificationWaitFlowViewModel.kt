...
class ProfileVerificationWaitFlowViewModel(
    ...
    companion object {
        private const val TAG = "ProfileVerificationWaitFlowViewModelTag"
    }

    override val isAuthorizationActive: Boolean = false

    fun getStartDestination() = StartDestination(R.id.profileVerificationWaitFragment)
