...
class ForgotPinShareYourDataViewModel(
    ...
    companion object {
        private const val TAG = "ForgotPinShareYourDataViewModelTag"
    }
    ...
    private fun authenticateUser(user: UserModel, pinCode: PinCode) {
        ...
        authorizationEnterToAccountUseCase.invoke(
            ...
            firebaseToken = preferences.readFirebaseToken()?.token ?: "",
            personalIdentificationNumber = user.personalIdentificationNumber ?: "null"
        ).onEach { result ->
            result.onLoading {
    ...
    fun toConfirmIdentificationFragment() {
        ...
        findFlowNavController().navigateInMainThread(
            ForgotPinShareYourDataFragmentDirections.toConfirmIdentificationFragment(),
            viewModelScope
        )
    }
    ...
    private fun toDisagreeFragment() {
        ...
        findFlowNavController().navigateInMainThread(
            ForgotPinShareYourDataFragmentDirections.toDisagreeFragment(),
            viewModelScope
        )
    }
