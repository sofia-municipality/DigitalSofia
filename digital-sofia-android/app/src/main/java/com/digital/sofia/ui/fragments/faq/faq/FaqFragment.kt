 ...
 **/
package com.digital.sofia.ui.fragments.faq.faq
    ...
    override fun onCreated() {
        try {
            ...
            val url = if (!token.isNullOrEmpty() && !refreshToken.isNullOrEmpty()) {
                URL_BASE_WEB_VIEW + "sm-faq/?hideNav=true&token=$token&refreshToken=$refreshToken&lang=$language"
            } else {
                URL_BASE_WEB_VIEW + "sm-faq/?hideNav=true&lang=$language"
            }
