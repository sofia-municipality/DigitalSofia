 ...
 **/
package com.digital.sofia.ui.fragments.main.services
    ...
    override fun onCreated(savedInstanceState: Bundle?) {
        try {
            ...
            val url = if (!accessToken.isNullOrEmpty() && !refreshToken.isNullOrEmpty()) {
                URL_BASE_WEB_VIEW + "my-services/?hideNav=true&token=$accessToken&refreshToken=$refreshToken&lang=$language"
            } else {
                logError("onCreated accessToken or refreshToken isNullOrEmpty", TAG)
                URL_BASE_WEB_VIEW + "my-services/?hideNav=true&lang=$language"
            }
