 ...
 **/
package com.digital.sofia.ui.fragments.forgot.disagree
...
import com.digital.sofia.ui.fragments.auth.AuthEnterCodeFlowFragmentDirections
...
class ForgotPinDisagreeViewModel(
    ...
    companion object {
        private const val TAG = "ForgotPinDisagreeViewModelTag"
    }
    ...
    fun onNextClicked() {
        ...
        findFlowNavController().navigateInMainThread(
            AuthEnterCodeFlowFragmentDirections.toEnterCodeFlowFragment(),
            viewModelScope
        )
    }
}